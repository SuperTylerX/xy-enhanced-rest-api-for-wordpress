...
function minapper_admin_menu() {
	...
	$config_submenu = array(
		...
		'id' => 'uni_app_expand_settings_page',              // Required, meta box id, unique per page, to save: get_option( id )
		'parent' => 'uni_app_slug',                   // Parent page of plugin menu (default Settings [options-general.php])
